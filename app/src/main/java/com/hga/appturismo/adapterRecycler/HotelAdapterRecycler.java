 ...
 */
public class HotelAdapterRecycler extends RecyclerView.Adapter<HotelViewHolder> implements Filterable {
    ...
    private double getPromedio(HotelViewHolder holder, ModeloHotel modeloHotel) {
        double promedio = 0;
        int calificados = 0;
    ...
    private void setCheckEstrellas(int cantidad, HotelViewHolder holder) {
        switch (cantidad) {
            case 1:
     ...
     * @param modeloHotel:
     */
    private void actualizarMarcarEstrellas(int estrellasMarcadas, HotelViewHolder holder, ModeloHotel modeloHotel) {
